...
def test_legacy_config_exports_unchanged():
    ...
    # Kern-Universum bleibt erhalten; neue Coins (z.B. HYPEUSDT) dürfen dazukommen
    for legacy_coin in ("BTCUSDT", "ETHUSDT", "BNBUSDT", "SOLUSDT", "XRPUSDT",
                        "ADAUSDT", "DOGEUSDT", "AVAXUSDT", "DOTUSDT", "POLUSDT"):
        assert legacy_coin in config.TOP_10_COINS
