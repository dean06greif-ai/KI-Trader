...
def test_weak_profile_tuning_does_not_reset_variant():
    # Bug 23.09: momentum_news zeigte 0 Trades, weil jedes schwache Auto-Tuning
    # (strong=False) bzw. Rollback die Variante neu startete.
    scope = {"eval_since": {"m": "2026-09-20T15:49:13+00:00"},
             "revisions": {"m": {"version": 1, "since": "2026-09-18T01:56:54+00:00"}},
             "lifecycle": {"m": {"versions": [
                 {"v": 1, "since": "2026-09-02T17:51:38+00:00"},
                 {"v": 2, "since": "2026-09-20T15:49:13+00:00", "strong": True},
                 {"v": 4, "since": "2026-09-21T09:29:42+00:00", "strong": False, "rollback_of": 2},
                 {"v": 6, "since": "2026-09-23T11:49:42+00:00", "strong": False}]},
                 "p": {"versions": [{"v": 1, "since": "2026-09-02T00:00:00+00:00"},
                                    {"v": 2, "since": "2026-09-23T10:26:55+00:00", "strong": True}]}}}
    m = setup_variant.variant_since_map(scope, ["m", "p"])
    assert m["m"].startswith("2026-09-20T15:49")   # letzte starke Änderung = Gate-Start
    assert m["p"].startswith("2026-09-23T10:26")   # starke Änderung setzt weiter neu
