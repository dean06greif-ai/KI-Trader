...
INDICATORS = [
    ...
    # Trendfilter-Erweiterung 06/2026 (Parität Fast-Path/Live/Optimizer):
    "supertrend", "supertrend_dir", "ema_slope_pct", "roc", "chop",
...
INDICATOR_META = {
    ...
    "supertrend": {"label": "Supertrend Linie", "group": "Trend"},
    "supertrend_dir": {"label": "Supertrend Richtung (1=auf, -1=ab)", "group": "Trend"},
    "ema_slope_pct": {"label": "EMA-Slow Steigung % (über Lookback)", "group": "Trend"},
    "roc": {"label": "ROC % (Rate of Change)", "group": "Momentum"},
    "chop": {"label": "Choppiness Index (>61.8 seitwärts, <38.2 Trend)", "group": "Trend"},
    "aroon_up": {"label": "Aroon Up (0-100)", "group": "Trend"},
    "aroon_down": {"label": "Aroon Down (0-100)", "group": "Trend"},
    "williams_r": {"label": "Williams %R (-100..0)", "group": "Momentum"},
...
PERIOD_FIELDS = [
    ...
    {"key": "supertrend_period", "label": "Supertrend ATR-Periode", "default": 10},
    {"key": "supertrend_mult", "label": "Supertrend Multiplikator", "default": 3.0},
    {"key": "slope_lookback", "label": "EMA-Steigung Lookback", "default": 5},
    {"key": "roc_period", "label": "ROC Periode", "default": 10},
    {"key": "chop_period", "label": "Choppiness Periode", "default": 14},
    {"key": "aroon_period", "label": "Aroon Periode", "default": 25},
    {"key": "williams_period", "label": "Williams %R Periode", "default": 14},
