...
async def strategy_comparison(mode: str = "all", days: int = 0,
    ...
    Performance und werden standardmäßig ausgeblendet (include_collection=true).
    'Karteileichen' (Trades gelöschter/nicht mehr existierender Strategien)
    werden standardmäßig ausgeblendet (include_stale=true)."""
