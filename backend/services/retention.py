...
DEFAULT_POLICY: List[Dict] = [
    ...
    # (09/2026 verschärft: 45 -> 30 Tage; das tägliche Backup sichert den Stand)
    {"coll": "ai_chat_archive", "ts": "ts", "days": 30, "keep_last": None},
    # Entscheidungen werden beim Tages-Reset ohnehin ins Archiv gespiegelt
    # (09/2026 verschärft: 21 -> 14 Tage – größter Einzelposten, Lernen nutzt 14 Tage)
    {"coll": "ai_decisions", "ts": "ts", "days": 14, "keep_last": None},
    ...
    # (09/2026 verschärft: Roh-Trades 30 -> 21 Tage, Läufe 20 -> 15)
    {"coll": "backtest_trades", "ts": "created_at", "days": 21, "keep_last": None},
    ...
    # Job-Ergebnisse/Token-Statistik/Copilot-Chat (09/2026: bisher ungedeckelt)
    {"coll": "job_series", "ts": "created_at", "days": 60, "keep_last": None},
    {"coll": "ai_token_usage", "ts": "ts", "days": 60, "keep_last": None},
    {"coll": "copilot_chat", "ts": "ts", "days": 45, "keep_last": None},
