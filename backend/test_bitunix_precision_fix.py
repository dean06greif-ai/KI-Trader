...
from decimal import ROUND_UP  # noqa: E402
...
def _install_avax_meta(client: BitunixTradeClient) -> None:
    ...
    client._pairs_meta = {
        "AVAXUSDT": {
            # Bitunix returns basePrecision=0 (whole units) + minTradeVolume=1
            "qty_step": _precision_to_step(0),
