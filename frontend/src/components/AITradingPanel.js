...
import FomcPanel from './FomcPanel';
import EconEventPanel from './EconEventPanel';
  ...
  return (
    <div className="ai-panel-overlay" onClick={onClose} data-testid="ai-trading-panel">
      <div className="ai-panel" onClick={e => e.stopPropagation()}>
        ...
        {/* Event-Setups: FOMC + CPI + NFP + PPI + PCE – Status, Backtest & Live-Opt-in */}
        {showFomc && (
          <div data-testid="ai-event-setups-section">
            <FomcPanel />
            <EconEventPanel eventKey="cpi" />
            <EconEventPanel eventKey="nfp" />
            <EconEventPanel eventKey="ppi" />
            <EconEventPanel eventKey="pce" />
          </div>
        )}
