...
const PerformanceAnalytics = ({ performance, strategies = [], enabledIds = [], signals, selectedCoin, selectedStrategy, strategyOverrides = {}, strategyCoinConfigs = {}, isAdmin, onNeedAdmin, onCleared, onShowChart }) => {
  ...
  // Performance: 'alle' = Live + Paper (ohne Sammlung), 'paper' nur echte
  // Paper-Trades, 'collection' nur die Sammlung – sie verfälscht sonst PnL/Statistik.
  ...
  const filterFn = (t) => {
    ...
    if (t.data_collection) return false;
