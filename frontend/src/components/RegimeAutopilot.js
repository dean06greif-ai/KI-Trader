...
const REASON = {
  ...
  worse: 'liegt unter der aktiven Kalibrierung desselben Grundgerüsts',
  ...
  return (
    <div className="opt-row rl-tool" data-testid="autopilot-section">
      ...
      <div className="opt-small" style={{ marginBottom: 6 }}>
        ...
        noch an der Robustheit (besserer Holdout / längere Ø Phase), bis du „Suche beenden (Bestes behalten)“ drückst.
