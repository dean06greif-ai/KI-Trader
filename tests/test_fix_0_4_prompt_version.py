...
async def main():
    ...
    ai_engine.db = db
    # run_analysis-Preflight braucht einen Provider-Key (kein LLM-Call:
    # _generate_json ist gestubbt) - Dummy-Env reicht lokal.
    if not ai_engine.key:
        os.environ["GEMINI_API_KEY"] = "test-key-04"
