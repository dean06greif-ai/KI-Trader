...
async def main():
    ...
    try:
        ...
        a = roles["analyst"]
        assert a["provider"] == "openrouter" and a["model"] == "nvidia/nemotron-3-super-120b-a12b:free"
        assert a["fallback_model"] == "openai/gpt-oss-20b:free"
        assert a["fallback2_model"] == "deepseek/deepseek-v4-flash"
        assert roles["chat"]["fallback_provider"] == "openrouter"
        assert roles["chat"]["fallback_model"] == "openai/gpt-oss-20b:free"
